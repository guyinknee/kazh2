...
const DataLoader = {
    ...
    async loadGeoJSONData() {
        ...
        // Consolidated Power Grid + Stations (GeoJSON)
        // NOTE: These replace the older CSV-based electricity/renewables layers.
            AppState.data.electricityNetwork = await this.loadGeoJSON('kz_power_lines.geojson');
            AppState.data.powerStations      = await this.loadGeoJSON('kz_power_stations.geojson');
            AppState.data.renewablePoints    = await this.loadGeoJSON('kz_renewable_energy.geojson');
    ...
    async loadCSVData() {
        // Green Hydrogen Data
        // AppState.data.renewablePoints = await this.loadCSV('renewable_energy_points.csv'); // disabled: replaced by GeoJSON consolidated layer
        // AppState.data.electricityNetwork = await this.loadCSV('electricity_network.csv'); // disabled: replaced by GeoJSON consolidated layer
